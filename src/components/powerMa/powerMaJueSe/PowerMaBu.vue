  ...
  <div class="PowerMaBu">
    ...
    <div class="table">
      <el-table :stripe="true" :border="false" ref="multipleTable" :data="tableData3" tooltip-effect="dark" style="width: 100%"  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="numberId"  label="角色编号" width="120">
        </el-table-column>
        <el-table-column prop="title" label="角色名称" width="120">
        </el-table-column>
        <el-table-column prop="bumen" label="所属部门" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="powerInfo" label="权限描述" show-overflow-tooltip>
        </el-table-column>
