		...
		<el-main>
			<el-table
			 ...
			 id="moneyTable" 
			  ...
			  tooltip-effect="dark" stripe style="font-size: 11px;" :data="tableData.slice((currentPage-1)*pagesize,currentPage*pagesize)"  :cell-style="{'text-align':'center',border:'none'}">
